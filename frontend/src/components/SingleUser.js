  ...
  return (
    <div>
      ...
      <div>
        ...
        {userToShow.showInstagram && <a id="ig-link" className='iconWrapper' href={userToShow.instagram}>
        ...
        {userToShow.showTwitter && <a id="twitter-link" className='iconWrapper' href={userToShow.twitter}>
