  ...
  return (
    <div>
      ...
      <div>
        ...
        {userToShow.showFacebook && <a className='iconWrapper' href={userToShow.facebook}>
        ...
        {userToShow.showInstagram && <a className='iconWrapper' href={userToShow.instagram}>
        ...
        {userToShow.showTwitter && <a className='iconWrapper' href={userToShow.twitter}>
